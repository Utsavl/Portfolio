...
document.getElementById("pc1").onscroll = function () {
  showDiffPro(this, this.id);
};
document.getElementById("pc2").onscroll = function () {
  showDiffPro(this, this.id);
};
document.getElementById("pc3").onscroll = function () {
  showDiffPro(this, this.id);
};
document.getElementById("pc4").onscroll = function () {
  showDiffPro(this, this.id);
};
